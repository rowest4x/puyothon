...
2025年2月に知能と情報（日本知能情報ファジィ学会誌）に掲載された[並列Actorと優先度付き経験再生を用いた深層強化学習によるぷよぷよAI](https://doi.org/10.3156/jsoft.37.1_501)で使用したものです。
AI本体は[こちら](https://github.com/rowest4x/puyopuyoai)にあります。

C 拡張によって実装されており、盤面更新・落下・連鎖判定などを高速に行うことができます。NumPy 配列で盤面を表現しており、AI 学習に適した構成になっています。
